...
\033[1;94mFACEBOOK  Sharif Jan
                  
\033[1;92mFB PAGE   Sharif Jan
...
╔══──────────────────────────╗─══╗
║ OWNER 💓💓💓  Sharifofficial        ║║
║  GITHUB 💝💝💝 Sharifofficial(SO)   ║ ║
║ FACEBOOK 💝💝💝Sharif Jan ║ ║
║  ENJOY 💝💝💝Afg Cloning                ║ ║
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝          ╚════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝
                         ...
                         DON'T COPY MY SCRIPT
                                      Sharif Official          
                                        TNX(SO)
╔══──────────────────────────╗─══╗
║OWNER 💓💓💓Sharifofficial (So)                              ║
║  GITHUB 💝💝💝Sharifofficial                             ║
║ FACEBOOK 💝💝💝Sharif Jan                 ║
║  ENJOY 💝💝💝Afg Cloning                             ║
║   Note 💝💝💝Use Fastest Speed Net             ║
╚══──────────────────────────╝─══╝
